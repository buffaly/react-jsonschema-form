 ...
 */
function validateFormData(formData, schema, customValidate, transformErrors, local) {
  try {
    ajv.validate(schema, formData);
    _ajvI18n2.default[local] && _ajvI18n2.default[local](ajv.errors);
  } catch (e) {
